...
// keyed by email, matching Customer's platform-wide uniqueness.
export interface IPendingCustomerSignup extends Document {
  email: string;
  /** Restaurant the signup started from, carried over for attribution. */
...
PendingCustomerSignupSchema.index({ email: 1 }, { unique: true });
